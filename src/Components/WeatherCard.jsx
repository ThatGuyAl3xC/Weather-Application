    ...
    return (
        <div className='w-[22rem] min-w-[22rem] h-[30rem] glassCard p-4'>
            ...
            <div className='w-full flex justify-between items-center mt-4'>
                <p className='flex-2 text-center font-semibold p-2'>{new Date().toDateString()}</p>
                <p className='flex-1 text-center font-semibold p-2'>{time}</p>
            </div>
            ...
            <div className='w-full p-1 mt-4 flex justify-between items-center'>
